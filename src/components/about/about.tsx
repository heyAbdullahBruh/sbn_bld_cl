...
import { Mail, CheckCircle2, Target, Eye, MapPin } from "lucide-react";
...
const About = () => {
  ...
  const reasons = t("about.why_start.reasons", {
    returnObjects: true,
  }) as string[];
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative py-24 bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          >
            {t("about.hero.heading_1")}{" "}
            <span className="text-primary">{t("about.hero.heading_2")}</span>
          </motion.h1>
          <motion.p
            {...fadeIn}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            <div className="space-y-4">
              {Array.isArray(reasons) &&
                reasons.map((text, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:border-primary/20 transition-colors"
                  >
        ...
        >
          ...
          <h2 className="text-3xl font-black mb-6">
            {t("about.working_areas.heading")}
          </h2>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            {t("about.working_areas.text")}{" "}
            <span className="text-white font-bold">
              {t("about.working_areas.areas")}
            </span>
          </p>
        </motion.div>
        ...
        <motion.section {...fadeIn} className="pt-24 border-t border-slate-100">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900">
              {t("about.founder.heading_1")}{" "}
              <span className="text-primary">
                {t("about.founder.heading_2")}
              </span>
            </h2>
          </div>
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-[40px] shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-5">
            <div className="lg:col-span-2 bg-slate-50 p-12 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-primary font-bold uppercase tracking-widest text-xs mb-8">
                {t("about.founder.role")}
              </p>

              <div className="flex gap-4">
                <FounderSocial
                  href="https://www.facebook.com/federalbloodwave"
                  icon={faFacebook}
                />
                <FounderSocial href="https://x.com/MrPieX" icon={faXTwitter} />
                <FounderSocial
                  href="https://www.linkedin.com/in/heyabdullahbro"
                  icon={faLinkedin}
                />
                <FounderSocial
                  href="https://abdullah-shayed.vercel.app/about"
                  icon={faGlobe}
                />
              </div>
            </div>
              ...
              <div className="flex items-center gap-4 pt-8 border-t border-slate-50">
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-widest text-slate-400">
                    {t("about.founder.direct_contact")}
                  </p>
                  <p className="text-slate-900 font-bold">
                    abdullah.shayed@protonmail.com
                  </p>
                </div>
              </div>
            </div>
