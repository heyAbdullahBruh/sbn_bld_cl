...
import { MapPin, Phone, Mail, Droplets, Heart } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              />
              <SocialLink
                href="https://x.com/FederalBloodW"
                icon={faXTwitter}
              />
              <SocialLink
                href="https://www.instagram.com/federalbloodwave.orga/"
                icon={faInstagram}
              />
              <SocialLink
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <ContactItem
                ...
                text="+880 1603 070892"
              />
              <ContactItem
                icon={Mail}
                label={t("footer.email")}
                text="federalbloodwave@gmail.com"
                isEmail
              />
            </div>
          </div>
          ...
          <div className="bg-white/5 rounded-3xl p-8 border border-white/10">
            ...
            <Link
              to="/auth"
              className="block text-center bg-primary hover:bg-primary-dark text-white py-3 rounded-2xl font-bold text-sm transition-all shadow-lg shadow-primary/20"
            >
              {t("footer.join_donor")}
            </Link>
          </div>
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
          ...
          <div className="flex items-center gap-1">
            ...
            />{" "}
            {t("footer.by")}{" "}
            <span className="text-slate-400 font-bold">Federal Team</span>
          </div>
        </div>
      </div>
    </footer>
